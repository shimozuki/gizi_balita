                        ...
                        <div class="card-body">
                            <form action="{{ route('balita.update', $balita->id) }}" method="POST">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-6">
                                        <label>LILA (cm)</label>
                                        <input type="number" step="any" name="lila" class="form-control" value="{{ $balita->lila }}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Lingkar Kepala (cm)</label>
                                        <input type="number" step="any" name="lingkar_kepala" class="form-control" value="{{ $balita->lingkar_kepala }}">
                                    </div>
                                </div>
                                <br>
