...
@section('title', 'SPKBalita | Data Lingkar Lengan Atas')
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Lingkar Lengan Atas (LILA)</h1>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Data LILA</h3>
                        </div>
                        <div class="card-body">
                            <a href="{{ url('/lila/create') }}" class="btn btn-info float-right mb-2">Tambah Data</a>
                            <table id="tableData" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="text-center" rowspan="2">Umur (bulan)</th>
                                        <th class="text-center" colspan="7">Lingkar Lengan Atas (cm)</th>
                                    </tr>
                                    <tr>
