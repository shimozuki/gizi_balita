   ...
   <div class="sidebar">
     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="/lila" class="nav-link {{ request()->is('lila') ? 'active' : '' }}">
         ...
         <li class="nav-item">
           <a href="/lingkar-kepala" class="nav-link {{ request()->is('lingkar-kepala') ? 'active' : '' }}">
         ...
         <li class="nav-item">
           <a href="{{ route('kader.index') }}" class="nav-link {{ request()->is('kader*') ? 'active' : '' }}">
         ...
         @if (auth()->user()->level == 'admin' || auth()->user()->level == 'kader')
         <li class="nav-item">
